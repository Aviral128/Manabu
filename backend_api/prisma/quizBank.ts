...
const SUBJECTS: Subject[] = [
  ...
  { title: "Biology Explorer", slug: "biology-explorer", description: "Life science practice across cells, systems, genetics, ecology, plant science, and human physiology.", category: "Biology", estimatedMinutes: 45, tags: ["cells", "systems", "ecology", "plants", "human-body"], topics: [
    ...
    { name: "Photosynthesis", focus: "photosynthesis converts light energy into chemical energy in green plants", practice: "tracking how carbon dioxide, water, and sunlight support glucose formation", trap: "thinking plants only respire at night and never respire during the day" },
    { name: "Respiration", focus: "respiration releases usable energy from food in living cells", practice: "comparing aerobic and anaerobic respiration", trap: "assuming breathing and respiration are exactly the same process" },
    { name: "Circulation", focus: "circulation transports oxygen, nutrients, hormones, and wastes through the body", practice: "mapping blood flow through the heart and major vessels", trap: "thinking arteries always carry oxygen-rich blood and veins always carry oxygen-poor blood without exception" },
    { name: "Reproduction and Development", focus: "reproduction and development explain how organisms produce offspring and grow through life stages", practice: "distinguishing fertilization, embryonic development, and inheritance basics", trap: "assuming reproduction is only about producing identical copies with no variation" },
  ]},
